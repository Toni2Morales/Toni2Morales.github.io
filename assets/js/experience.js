...
const exp = [
   {
    ...
    cardImage: "assets/images/experience-page/FUTURA_VIVE.png",
    place: "Futura VIVE",
    time: "Mayo 2026 - Actualidad",
    desp: "<li>Programación en Python(FastAPI, SQLAlchemy, Piper-TTS)</li><li>Uso de librerías de Machine Learning y Visión Artificial(OpenCV, MediaPipe, YOLO)</li><li>Programación en JavaScript y TypeScript(React, Next.js, Electron)</li><li>Uso de Herramientas Colaborativas(Git, Github)</li>",
  },
   {
    title: "Desarrollador python (Prácticas)",
    cardImage: "assets/images/experience-page/HechicerIA.jpeg",
    place: "MystherAI",
    time: "Marzo 2026 - Mayo 2026",
    desp: "<li>Programación en Python(Langchain)</li><li>Uso de librerías de IA generativa(Decart, HunyuanWorld)</li><li>Herramientas CLOUD(AWS, Google Colaboratory)</li><li>Uso de Herramientas Colaborativas(Git, Github)</li>",
  },
 {
    title: "Data Engineer",
    ...
    desp: "<li>Programación en Python</li><li>Ticketing(Service Now)</li><li>Scripting en Bash(Linux)</li><li>Uso de Cyberark para conexión remota.</li><li>Desarrollo con SQL</li><li>Excel</li><li>Power BI</li>",
  },
  {
    title: "Desarrollador Python (Prácticas)",
  ...
  },
  {
    ...
    desp: "<li>Enseñanza de programación en Python</li><li>Instrucción sobre análisis de datos</li><li>Explicación de modelos predictivos e inteligencias artificiales</li><li>Teoría y ejercicios prácticos</li><li>Enseñanza de despliegue de proyectos</li>",
  },
  {
    ...
    desp: "<li>Enseñanza de programación en C++</li><li>Explicación de conceptos físicos y electrónicos</li><li>Creación de proyectos de robótica</li><li>Diseño y creación de circuitos eléctricos</li>",
  },
    {
